  ...
  return (
    <div className='Bottom'>
      <p style={{ color: "white", textShadow: "1px 4px 5px black" }}>
        © 2022 WOLF TV is owned by PFISD/Weiss High School | WOLF TV website developed by <a href='https://marke16.github.io/my-website/' title="Oh neat, you're about to go to my website, huh?" className='link' target="_blank" rel='noreferrer'>Mark Evola</a> | v1.2.2 |
